...
.method public visit([Lcom/android/dx/io/instructions/DecodedInstruction;Lcom/android/dx/io/instructions/DecodedInstruction;)V
    ...
    .line 83
    .local v0, "fieldId":I
    iget-object v1, p0, Lcom/android/dx/command/findusages/FindUsages$1;->this$0:Lcom/android/dx/command/findusages/FindUsages;

    # getter for: Lcom/android/dx/command/findusages/FindUsages;->fieldIds:Ljava/util/Set;
    invoke-static {v1}, Lcom/android/dx/command/findusages/FindUsages;->access$000(Lcom/android/dx/command/findusages/FindUsages;)Ljava/util/Set;
    ...
    .line 84
    iget-object v1, p0, Lcom/android/dx/command/findusages/FindUsages$1;->val$out:Ljava/io/PrintWriter;

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v3, p0, Lcom/android/dx/command/findusages/FindUsages$1;->this$0:Lcom/android/dx/command/findusages/FindUsages;
    ...
    iget-object v3, p0, Lcom/android/dx/command/findusages/FindUsages$1;->val$dex:Lcom/android/dex/Dex;

    invoke-virtual {v3}, Lcom/android/dex/Dex;->fieldIds()Ljava/util/List;
