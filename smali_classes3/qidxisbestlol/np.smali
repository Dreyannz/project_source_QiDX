...
.field public static final c:Lqidxisbestlol/ni;

.field public static final d:Lqidxisbestlol/nd;
...
.field private static final h:Lqidxisbestlol/vc;

.field private static final i:Lqidxisbestlol/jq;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lqidxisbestlol/np;->a:[B

    sget-object v0, Lqidxisbestlol/mk;->a:Lqidxisbestlol/mm;

    new-array v1, v3, [Ljava/lang/String;

    invoke-virtual {v0, v1}, Lqidxisbestlol/mm;->a([Ljava/lang/String;)Lqidxisbestlol/mk;

    move-result-object v0

    sput-object v0, Lqidxisbestlol/np;->b:Lqidxisbestlol/mk;

    sget-object v0, Lqidxisbestlol/ni;->a:Lqidxisbestlol/nj;

    sget-object v1, Lqidxisbestlol/np;->a:[B

    invoke-static {v0, v1, v2, v7, v2}, Lqidxisbestlol/nj;->a(Lqidxisbestlol/nj;[BLqidxisbestlol/mu;ILjava/lang/Object;)Lqidxisbestlol/ni;

    move-result-object v0

    sput-object v0, Lqidxisbestlol/np;->c:Lqidxisbestlol/ni;
    ...
    invoke-static/range {v0 .. v6}, Lqidxisbestlol/ne;->a(Lqidxisbestlol/ne;[BLqidxisbestlol/mu;IIILjava/lang/Object;)Lqidxisbestlol/nd;

    move-result-object v0

    sput-object v0, Lqidxisbestlol/np;->d:Lqidxisbestlol/nd;

    sget-object v0, Lqidxisbestlol/vc;->b:Lqidxisbestlol/vd;

    const/4 v1, 0x5

    new-array v1, v1, [Lqidxisbestlol/ur;

    sget-object v2, Lqidxisbestlol/ur;->b:Lqidxisbestlol/us;

    const-string v4, "efbbbf"

    invoke-virtual {v2, v4}, Lqidxisbestlol/us;->c(Ljava/lang/String;)Lqidxisbestlol/ur;
    ...
    invoke-virtual {v2, v3}, Lqidxisbestlol/us;->c(Ljava/lang/String;)Lqidxisbestlol/ur;
    ...
    sget-object v3, Lqidxisbestlol/ur;->b:Lqidxisbestlol/us;

    const-string v4, "fffe"

    invoke-virtual {v3, v4}, Lqidxisbestlol/us;->c(Ljava/lang/String;)Lqidxisbestlol/ur;
    ...
    invoke-virtual {v0, v1}, Lqidxisbestlol/vd;->a([Lqidxisbestlol/ur;)Lqidxisbestlol/vc;

    move-result-object v0

    sput-object v0, Lqidxisbestlol/np;->h:Lqidxisbestlol/vc;
    ...
    :cond_0
    sput-object v0, Lqidxisbestlol/np;->e:Ljava/util/TimeZone;
    ...
    sput-object v1, Lqidxisbestlol/np;->i:Lqidxisbestlol/jq;
    ...
    sput-boolean v0, Lqidxisbestlol/np;->f:Z
    ...
    invoke-static {v1, v0}, Lqidxisbestlol/js;->a(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-static {v1, v0}, Lqidxisbestlol/js;->b(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lqidxisbestlol/np;->g:Ljava/lang/String;
...
.method public static synthetic a(Ljava/lang/String;CIIILjava/lang/Object;)I
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3}, Lqidxisbestlol/np;->a(Ljava/lang/String;CII)I
...
.method public static synthetic a(Ljava/lang/String;IIILjava/lang/Object;)I
    ...
    :cond_1
    invoke-static {p0, p1, p2}, Lqidxisbestlol/np;->a(Ljava/lang/String;II)I
...
.method public static final a(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    invoke-static {v0, v2, v3, v4, v5}, Lqidxisbestlol/js;->a(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
...
.method public static final a(Lqidxisbestlol/uq;)I
    .locals 3
    ...
    invoke-interface {p0}, Lqidxisbestlol/uq;->i()B
    ...
    invoke-static {v1, v2}, Lqidxisbestlol/np;->a(BI)I
...
.method public static final a(Lqidxisbestlol/ng;)J
    .locals 4
    ...
    invoke-virtual {p0}, Lqidxisbestlol/ng;->h()Lqidxisbestlol/mk;

    move-result-object v2

    const-string v3, "Content-Length"

    invoke-virtual {v2, v3}, Lqidxisbestlol/mk;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method public static final varargs a(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    sget-object v0, Lqidxisbestlol/ii;->a:Lqidxisbestlol/ii;
...
.method public static final a(Lqidxisbestlol/mn;Z)Ljava/lang/String;
    .locals 5
    ...
    invoke-virtual {p0}, Lqidxisbestlol/mn;->m()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lqidxisbestlol/mn;->n()I

    move-result v1

    sget-object v2, Lqidxisbestlol/mn;->a:Lqidxisbestlol/mq;

    invoke-virtual {p0}, Lqidxisbestlol/mn;->l()Ljava/lang/String;
...
.method public static synthetic a(Lqidxisbestlol/mn;ZILjava/lang/Object;)Ljava/lang/String;
    .locals 1
    ...
    :cond_0
    invoke-static {p0, p1}, Lqidxisbestlol/np;->a(Lqidxisbestlol/mn;Z)Ljava/lang/String;
...
.method public static final a(Lqidxisbestlol/uq;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    .locals 1
    ...
    sget-object v0, Lqidxisbestlol/np;->h:Lqidxisbestlol/vc;

    invoke-interface {p0, v0}, Lqidxisbestlol/uq;->a(Lqidxisbestlol/vc;)I
    ...
    invoke-static {p1, v0}, Lqidxisbestlol/ia;->a(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :pswitch_4
    sget-object v0, Lqidxisbestlol/jn;->g:Lqidxisbestlol/jn;

    invoke-virtual {v0}, Lqidxisbestlol/jn;->b()Ljava/nio/charset/Charset;
    ...
    invoke-virtual {v0}, Lqidxisbestlol/jn;->a()Ljava/nio/charset/Charset;
...
.method public static final a(Lqidxisbestlol/mk;)Ljava/util/List;
    .locals 5
    ...
    invoke-static {v0, v1}, Lqidxisbestlol/it;->b(II)Lqidxisbestlol/ir;
    ...
    invoke-direct {v3, v4, v0}, Lqidxisbestlol/qp;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static final a(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-direct {v0, p0, p1}, Lqidxisbestlol/nr;-><init>(Ljava/lang/String;Z)V
...
.method public static final a(Lqidxisbestlol/ly;)Lqidxisbestlol/mb;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lqidxisbestlol/nq;-><init>(Lqidxisbestlol/ly;)V

    check-cast v0, Lqidxisbestlol/mb;

    return-object v0
.end method

.method public static final a(Ljava/util/List;)Lqidxisbestlol/mk;
    .locals 4
    ...
    invoke-virtual {v0}, Lqidxisbestlol/qp;->a()Lqidxisbestlol/ur;

    move-result-object v3

    invoke-virtual {v0}, Lqidxisbestlol/qp;->b()Lqidxisbestlol/ur;

    move-result-object v0

    invoke-virtual {v3}, Lqidxisbestlol/ur;->c()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v0}, Lqidxisbestlol/ur;->c()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v1, v3, v0}, Lqidxisbestlol/ml;->b(Ljava/lang/String;Ljava/lang/String;)Lqidxisbestlol/ml;

    goto :goto_0

    :cond_0
    invoke-virtual {v1}, Lqidxisbestlol/ml;->b()Lqidxisbestlol/mk;
...
.method public static final a(Lqidxisbestlol/up;I)V
    .locals 1
    ...
    invoke-interface {p0, v0}, Lqidxisbestlol/up;->c(I)Lqidxisbestlol/up;
...
.method public static final a(Ljava/net/Socket;Lqidxisbestlol/uq;)Z
    .locals 4
    ...
    invoke-interface {p1}, Lqidxisbestlol/uq;->f()Z
    :try_end_1
...
.method public static final a(Lqidxisbestlol/mn;Lqidxisbestlol/mn;)Z
    .locals 2
    ...
    invoke-virtual {p1}, Lqidxisbestlol/mn;->l()Ljava/lang/String;
...
.method public static final a(Lqidxisbestlol/vn;ILjava/util/concurrent/TimeUnit;)Z
    .locals 12
    ...
    invoke-interface {p0}, Lqidxisbestlol/vn;->a()Lqidxisbestlol/vo;
    ...
    invoke-virtual {v4, v8, v9}, Lqidxisbestlol/vo;->a(J)Lqidxisbestlol/vo;

    nop

    :try_start_0
    new-instance v4, Lqidxisbestlol/un;

    invoke-direct {v4}, Lqidxisbestlol/un;-><init>()V

    :goto_1
    const-wide/16 v8, 0x2000

    invoke-interface {p0, v4, v8, v9}, Lqidxisbestlol/vn;->a(Lqidxisbestlol/un;J)J
    ...
    invoke-virtual {v4}, Lqidxisbestlol/un;->t()V
    :try_end_0
    ...
    invoke-virtual {v2, v0, v1}, Lqidxisbestlol/vo;->a(J)Lqidxisbestlol/vo;
...
.method public static synthetic b(Ljava/lang/String;IIILjava/lang/Object;)I
    ...
    :cond_1
    invoke-static {p0, p1, p2}, Lqidxisbestlol/np;->b(Ljava/lang/String;II)I
...
.method public static final b(Ljava/lang/String;)Z
    ...
    sget-object v0, Lqidxisbestlol/np;->i:Lqidxisbestlol/jq;

    check-cast p0, Ljava/lang/CharSequence;

    invoke-virtual {v0, p0}, Lqidxisbestlol/jq;->a(Ljava/lang/CharSequence;)Z
...
.method public static final b(Lqidxisbestlol/vn;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1
    ...
    :try_start_0
    invoke-static {p0, p1, p2}, Lqidxisbestlol/np;->a(Lqidxisbestlol/vn;ILjava/util/concurrent/TimeUnit;)Z
    :try_end_0
...
.method public static final c(Ljava/lang/String;II)Ljava/lang/String;
    ...
    invoke-static {p0, v0, p2}, Lqidxisbestlol/np;->b(Ljava/lang/String;II)I
...
.method public static synthetic c(Ljava/lang/String;IIILjava/lang/Object;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {p0, p1, p2}, Lqidxisbestlol/np;->c(Ljava/lang/String;II)Ljava/lang/String;
