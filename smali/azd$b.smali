...
# instance fields
.field final synthetic QX:Lazd;

.field private final XL:Ljava/lang/Process;

.field private aM:Lbbl;
...
.method constructor <init>(Lazd;)V
    ...
    iput-object p1, p0, Lazd$b;->QX:Lazd;
    ...
    invoke-virtual {p1}, Lazd;->v5()Ljava/lang/String;
    ...
    iput-object v0, p0, Lazd$b;->XL:Ljava/lang/Process;

    new-instance v0, Lbbj;

    invoke-direct {v0}, Lbbj;-><init>()V

    invoke-virtual {p0, v0}, Lazd$b;->j6(Ljava/io/Writer;)V

    iget-object v1, p0, Lazd$b;->XL:Ljava/lang/Process;
    ...
    iput-object v2, p0, Lazd$b;->aM:Lbbl;

    iget-object v0, p0, Lazd$b;->aM:Lbbl;

    invoke-virtual {v0}, Lbbl;->start()V

    iget-object v0, p0, Lazd$b;->XL:Ljava/lang/Process;
    ...
    invoke-virtual {p0, v0, v1}, Lazd$b;->j6(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    :try_end_0
    .catch Lapw; {:try_start_0 .. :try_end_0} :catch_2
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1

    :try_start_1
    invoke-virtual {p0}, Lazd$b;->VH()V
    :try_end_1
    ...
    invoke-virtual {p0}, Lazd$b;->FH()Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lazd$b;->XL:Ljava/lang/Process;
    ...
    invoke-virtual {p0}, Lazd$b;->u7()V

    new-instance v0, Lapw;

    iget-object v1, p0, Lazd$b;->DW:Lazi;
...
.method public u7()V
    ...
    iput-object v1, p0, Lazd$b;->aM:Lbbl;
