...
.field private J8:Lcom/google/android/gms/common/internal/k;

.field private VH:Lcom/google/android/gms/common/api/i;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private u7:Lcom/google/android/gms/common/api/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "TR;"
        }
...
.method private final DW()Lcom/google/android/gms/common/api/h;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TR;"
    ...
    invoke-static {v1, v3}, Lcom/google/android/gms/common/internal/p;->j6(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->u7:Lcom/google/android/gms/common/api/h;

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->u7:Lcom/google/android/gms/common/api/h;

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->VH:Lcom/google/android/gms/common/api/i;
    ...
    invoke-interface {v0, p0}, Lcom/google/android/gms/common/api/internal/ab;->j6(Lcom/google/android/gms/common/api/internal/BasePendingResult;)V
...
.method public static DW(Lcom/google/android/gms/common/api/h;)V
    .locals 4
    ...
    invoke-interface {v0}, Lcom/google/android/gms/common/api/g;->j6()V
    :try_end_0
...
.method private final FH(Lcom/google/android/gms/common/api/h;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TR;)V"
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->u7:Lcom/google/android/gms/common/api/h;

    const/4 p1, 0x0

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->J8:Lcom/google/android/gms/common/internal/k;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->u7:Lcom/google/android/gms/common/api/h;

    invoke-interface {v0}, Lcom/google/android/gms/common/api/h;->j6()Lcom/google/android/gms/common/api/Status;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->VH:Lcom/google/android/gms/common/api/i;

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->VH:Lcom/google/android/gms/common/api/i;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->DW()Lcom/google/android/gms/common/api/h;

    move-result-object v1

    invoke-virtual {p1, v0, v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult$a;->j6(Lcom/google/android/gms/common/api/i;Lcom/google/android/gms/common/api/h;)V
    ...
    invoke-interface {v2, v3}, Lcom/google/android/gms/common/api/f$a;->j6(Lcom/google/android/gms/common/api/Status;)V
...
.method static synthetic j6(Lcom/google/android/gms/common/api/internal/BasePendingResult;)Lcom/google/android/gms/common/api/h;
    .locals 0

    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->u7:Lcom/google/android/gms/common/api/h;
...
# virtual methods
.method protected abstract DW(Lcom/google/android/gms/common/api/Status;)Lcom/google/android/gms/common/api/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final j6(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->DW(Lcom/google/android/gms/common/api/Status;)Lcom/google/android/gms/common/api/h;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->j6(Lcom/google/android/gms/common/api/h;)V
...
.method public final j6(Lcom/google/android/gms/common/api/h;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TR;)V"
    ...
    invoke-static {v1, v4}, Lcom/google/android/gms/common/internal/p;->j6(ZLjava/lang/Object;)V
    ...
    invoke-static {v2, v1}, Lcom/google/android/gms/common/internal/p;->j6(ZLjava/lang/Object;)V

    invoke-direct {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->FH(Lcom/google/android/gms/common/api/h;)V
