...
.method public final j6(Landroid/content/res/Resources;II)V
    ...
    sget v0, Laeq$b;->common_google_signin_btn_icon_dark:I

    sget v1, Laeq$b;->common_google_signin_btn_icon_light:I

    sget v2, Laeq$b;->common_google_signin_btn_icon_light:I

    invoke-static {p3, v0, v1, v2}, Lcom/google/android/gms/common/internal/SignInButtonImpl;->j6(IIII)I

    move-result v0

    sget v1, Laeq$b;->common_google_signin_btn_text_dark:I

    sget v2, Laeq$b;->common_google_signin_btn_text_light:I

    sget v3, Laeq$b;->common_google_signin_btn_text_light:I

    invoke-static {p3, v1, v2, v3}, Lcom/google/android/gms/common/internal/SignInButtonImpl;->j6(IIII)I
    ...
    invoke-static {v0}, Lc;->DW(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    sget v1, Laeq$a;->common_google_signin_btn_tint:I

    invoke-virtual {p1, v1}, Landroid/content/res/Resources;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object v1

    invoke-static {v0, v1}, Lc;->j6(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    sget-object v1, Landroid/graphics/PorterDuff$Mode;->SRC_ATOP:Landroid/graphics/PorterDuff$Mode;

    invoke-static {v0, v1}, Lc;->j6(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    sget v0, Laeq$a;->common_google_signin_btn_text_dark:I

    sget v1, Laeq$a;->common_google_signin_btn_text_light:I

    sget v3, Laeq$a;->common_google_signin_btn_text_light:I

    invoke-static {p3, v0, v1, v3}, Lcom/google/android/gms/common/internal/SignInButtonImpl;->j6(IIII)I
    ...
    :pswitch_3
    sget p2, Laeq$c;->common_signin_button_text_long:I
    ...
    :pswitch_4
    sget p2, Laeq$c;->common_signin_button_text:I
