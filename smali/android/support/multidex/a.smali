...
.method private static DW(Landroid/content/Context;)Landroid/content/pm/ApplicationInfo;
    .locals 2
...
.method public static j6(Landroid/content/Context;)V
    ...
    :try_start_0
    invoke-static {p0}, Landroid/support/multidex/a;->DW(Landroid/content/Context;)Landroid/content/pm/ApplicationInfo;
...
.method private static j6(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    :cond_2
    :try_start_3
    invoke-static {p0}, Landroid/support/multidex/a;->FH(Landroid/content/Context;)V
    :try_end_3
    ...
    :try_start_5
    invoke-virtual {p3, p0, p4, v2}, Landroid/support/multidex/b;->j6(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    :try_start_6
    invoke-static {v1, p2, v2}, Landroid/support/multidex/a;->j6(Ljava/lang/ClassLoader;Ljava/io/File;Ljava/util/List;)V
    :try_end_6
    ...
    invoke-virtual {p3, p0, p4, p5}, Landroid/support/multidex/b;->j6(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
