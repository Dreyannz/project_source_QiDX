...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v4/media/MediaBrowserCompat$i;->Hw()V
.end annotation
...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserCompat$i;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$i$1;->j6:Landroid/support/v4/media/MediaBrowserCompat$i;
...
.method public run()V
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i$1;->j6:Landroid/support/v4/media/MediaBrowserCompat$i;
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$i$1;->j6:Landroid/support/v4/media/MediaBrowserCompat$i;

    iget-object v2, v2, Landroid/support/v4/media/MediaBrowserCompat$i;->VH:Landroid/support/v4/media/MediaBrowserCompat$i$a;
    ...
    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserCompat$i;->u7:Landroid/os/Messenger;
    ...
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$i$1;->j6:Landroid/support/v4/media/MediaBrowserCompat$i;
    ...
    iput-object v2, v1, Landroid/support/v4/media/MediaBrowserCompat$i;->VH:Landroid/support/v4/media/MediaBrowserCompat$i$a;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$1;->j6:Landroid/support/v4/media/MediaBrowserCompat$i;

    iget-object v3, v3, Landroid/support/v4/media/MediaBrowserCompat$i;->VH:Landroid/support/v4/media/MediaBrowserCompat$i$a;
    ...
    iget-object v2, v2, Landroid/support/v4/media/MediaBrowserCompat$i;->gn:Landroid/support/v4/media/MediaBrowserCompat$l;
