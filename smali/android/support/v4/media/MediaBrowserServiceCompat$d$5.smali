...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v4/media/MediaBrowserServiceCompat$d;->j6(Ljava/lang/String;Landroid/support/v4/os/ResultReceiver;Landroid/support/v4/media/MediaBrowserServiceCompat$e;)V
.end annotation
...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserServiceCompat$d;Landroid/support/v4/media/MediaBrowserServiceCompat$e;Ljava/lang/String;Landroid/support/v4/os/ResultReceiver;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$5;->Hw:Landroid/support/v4/media/MediaBrowserServiceCompat$d;

    iput-object p2, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$5;->j6:Landroid/support/v4/media/MediaBrowserServiceCompat$e;

    iput-object p3, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$5;->DW:Ljava/lang/String;

    iput-object p4, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$5;->FH:Landroid/support/v4/os/ResultReceiver;
...
.method public run()V
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$5;->j6:Landroid/support/v4/media/MediaBrowserServiceCompat$e;

    invoke-interface {v0}, Landroid/support/v4/media/MediaBrowserServiceCompat$e;->j6()Landroid/os/IBinder;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$5;->Hw:Landroid/support/v4/media/MediaBrowserServiceCompat$d;
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$5;->DW:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$5;->FH:Landroid/support/v4/os/ResultReceiver;
