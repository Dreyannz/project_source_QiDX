...
.field VH:Landroid/support/v4/media/MediaBrowserCompat$i$a;

.field Zo:I

.field gn:Landroid/support/v4/media/MediaBrowserCompat$l;

.field final j6:Landroid/content/Context;

.field private final tp:Lh;
...
.field u7:Landroid/os/Messenger;
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;Landroid/support/v4/media/MediaBrowserCompat$b;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->tp:Lh;

    const/4 v0, 0x1

    iput v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->Zo:I
...
.method private j6(Landroid/os/Messenger;Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->u7:Landroid/os/Messenger;

    const/4 v1, 0x1

    if-ne v0, p1, :cond_1

    iget p1, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->Zo:I
    ...
    iget-object p2, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->u7:Landroid/os/Messenger;
...
.method public DW()Z
    ...
    iget v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->Zo:I
...
.method FH()V
    ...
    iget v2, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->Zo:I
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->VH:Landroid/support/v4/media/MediaBrowserCompat$i$a;
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->gn:Landroid/support/v4/media/MediaBrowserCompat$l;
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->u7:Landroid/os/Messenger;
...
.method public Zo()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/MediaBrowserCompat$i;->DW()Z
...
.method j6()V
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->VH:Landroid/support/v4/media/MediaBrowserCompat$i$a;
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->VH:Landroid/support/v4/media/MediaBrowserCompat$i$a;

    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->gn:Landroid/support/v4/media/MediaBrowserCompat$l;

    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->u7:Landroid/os/Messenger;
...
.method public j6(Landroid/os/Messenger;)V
    ...
    iget v1, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->Zo:I
    ...
    invoke-virtual {p1}, Landroid/support/v4/media/MediaBrowserCompat$b;->FH()V
...
.method public j6(Landroid/os/Messenger;Ljava/lang/String;Landroid/support/v4/media/session/MediaSessionCompat$Token;Landroid/os/Bundle;)V
    ...
    iget p3, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->Zo:I

    invoke-static {p3}, Landroid/support/v4/media/MediaBrowserCompat$i;->j6(I)Ljava/lang/String;
    ...
    iput p1, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->Zo:I
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/MediaBrowserCompat$i;->FH()V
    ...
    :try_start_0
    iget-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->tp:Lh;

    invoke-virtual {p1}, Lh;->entrySet()Ljava/util/Set;
    ...
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->gn:Landroid/support/v4/media/MediaBrowserCompat$l;
    ...
    invoke-static {v2}, Landroid/support/v4/media/MediaBrowserCompat$n;->j6(Landroid/support/v4/media/MediaBrowserCompat$n;)Landroid/os/IBinder;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->u7:Landroid/os/Messenger;

    invoke-virtual {v1, p3, v2, v3, v4}, Landroid/support/v4/media/MediaBrowserCompat$l;->j6(Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Bundle;Landroid/os/Messenger;)V
    :try_end_0
