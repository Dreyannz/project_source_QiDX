...
.method public constructor <init>(Lwl;)V
    ...
    iput-object p1, p0, Lws;->j6:Ljava/util/TreeMap;
...
# virtual methods
.method public DW(Laam;)I
    .locals 1

    if-eqz p1, :cond_1

    invoke-virtual {p0}, Lws;->u7()V

    iget-object v0, p0, Lws;->j6:Ljava/util/TreeMap;
...
.method public j6(Laam;)Lwr;
    .locals 2

    if-eqz p1, :cond_1

    invoke-virtual {p0}, Lws;->tp()V
    ...
    invoke-direct {v0, p1}, Lwr;-><init>(Laam;)V

    iget-object v1, p0, Lws;->j6:Ljava/util/TreeMap;
