...
.method gn()Z
    ...
    iget-boolean v0, p0, Lbet;->DW:Z

    const/4 v1, 0x1

    if-nez v0, :cond_1

    iget-boolean v0, p0, Lbet;->FH:Z
    ...
    :cond_0
    iget-object v0, p0, Lbet;->Hw:Lbcc;

    invoke-interface {v0}, Lbcc;->Q_()Lbcq;

    move-result-object v0

    invoke-virtual {v0}, Lbcq;->VH()Lbcq;
...
.method j6(Lbco;)V
    ...
    iget-boolean v2, p0, Lbet;->FH:Z

    if-eqz v2, :cond_0

    iget v2, p0, Lbet;->j6:I
    ...
    :cond_2
    iget v0, p0, Lbet;->j6:I

    sget-object v2, Lbet;->v5:[B
...
.method u7()I
    ...
    iget-boolean v1, p0, Lbet;->FH:Z

    if-eqz v1, :cond_0

    iget v1, p0, Lbet;->j6:I
