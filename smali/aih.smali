...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Laih;->j6:Ljava/util/Queue;

    new-instance v0, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v0}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v0, p0, Laih;->DW:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public DW()Laig;
    ...
    :try_start_0
    invoke-virtual {p0, v0, v1, v1}, Laih;->DW(ILjava/lang/Long;Ljava/util/concurrent/TimeUnit;)Laig;
...
.method DW(ILjava/lang/Long;Ljava/util/concurrent/TimeUnit;)Laig;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, p3}, Laih;->j6(ILjava/lang/Long;Ljava/util/concurrent/TimeUnit;)Laig;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {p0, v0}, Laih;->j6(Laig;)Z
    ...
    :cond_0
    invoke-virtual {p0, p1, v0}, Laih;->j6(ILaig;)Z
...
.method public Hw()V
    ...
    :try_start_0
    iget-object v0, p0, Laih;->DW:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    iget-object v0, p0, Laih;->j6:Ljava/util/Queue;
    ...
    invoke-virtual {p0, v1}, Laih;->j6(Laig;)Z
    ...
    iget-object v1, p0, Laih;->DW:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public drainTo(Ljava/util/Collection;)I
    ...
    iget-object v1, p0, Laih;->j6:Ljava/util/Queue;
    ...
    :cond_0
    iget-object p1, p0, Laih;->DW:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public drainTo(Ljava/util/Collection;I)I
    ...
    iget-object p2, p0, Laih;->DW:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public j6()Laig;
    ...
    invoke-virtual {p0, v1, v0, v0}, Laih;->DW(ILjava/lang/Long;Ljava/util/concurrent/TimeUnit;)Laig;
...
.method j6(ILjava/lang/Long;Ljava/util/concurrent/TimeUnit;)Laig;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
...
.method public j6(JLjava/util/concurrent/TimeUnit;)Laig;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    invoke-virtual {p0, p2, p1, p3}, Laih;->DW(ILjava/lang/Long;Ljava/util/concurrent/TimeUnit;)Laig;
...
.method j6(ILaig;)Z
    ...
    :cond_0
    iget-object p1, p0, Laih;->j6:Ljava/util/Queue;
...
.method public synthetic peek()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Laih;->DW()Laig;
...
.method public synthetic poll()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Laih;->FH()Laig;
...
.method public synthetic poll(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Laih;->j6(JLjava/util/concurrent/TimeUnit;)Laig;
...
.method public synthetic take()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Laih;->j6()Laig;
...
.method public toArray()[Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, v1}, Laih;->j6([Ljava/lang/Object;[Ljava/lang/Object;)[Ljava/lang/Object;
...
.method public toArray([Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, p1}, Laih;->j6([Ljava/lang/Object;[Ljava/lang/Object;)[Ljava/lang/Object;
